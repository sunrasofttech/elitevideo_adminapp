...
import 'package:elite_admin/bloc/web_series/episode/get_all_episode/get_all_episode_model.dart';
...
class AddUpdateEpisodeScreen extends StatefulWidget {
  const AddUpdateEpisodeScreen({super.key, this.id, this.item});
  final String? id;
  final Datum? item;

  @override
  State<AddUpdateEpisodeScreen> createState() => _AddUpdateEpisodeScreenState();
}

class _AddUpdateEpisodeScreenState extends State<AddUpdateEpisodeScreen> with Utility {
