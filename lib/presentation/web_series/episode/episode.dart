...
import 'package:elite_admin/presentation/web_series/episode/add_update_episode_screen.dart';
...
class _EpisodeScreenState extends State<EpisodeScreen> with Utility {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async {
        await context.read<GetAllEpisodeCubit>().getAllEpisode();
      },
      child: Scaffold(
        body: Padding(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  widthBox10(),
                  Expanded(
                    child: BlocBuilder<GetAllSeasonCubit, GetAllSeasonState>(
                      builder: (context, state) {
                        ...
                        onTap: () {
                          showDialog(
                            ...
                            builder: (_) => DeleteDialog(
                              ...
                              onDeletePressed: () {
                                context.read<DeleteEpisodeCubit>().deleteEpisode(selectedMovieIds);
                              },
                            ),
                          );
                        },
