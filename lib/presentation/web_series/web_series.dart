  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        ...
        child: ListView(
          children: [
            const TextWidget(text: "Manage Series", fontSize: 15, fontWeight: FontWeight.w600),
            heightBox15(),
            Row(
              children: [
                Expanded(
                  child: TextFormFieldWidget(
                    ...
                    onChanged: (p0) {
                      context.read<GetAllSeriesCubit>().getAllSeries(search: p0);
                    },
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const AddUpdateSeriesScreen()));
                  },
                  child: Container(
                        ...
                        return CustomDropdown(
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              context.read<GetAllSeriesCubit>().getAllSeries(languageId: selectedLanguageId);
                            });
                          },
                        );
                      }
                        ...
                        return CustomDropdown(
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              print("Selected Datum ID: ${selectedDatum?.id}");
                              context.read<GetAllSeriesCubit>().getAllSeries(categoryId: selectedCategoryId);
                            });
                          },
                        );
                      }
                                                      ...
                                                      child: InkWell(
                                                        onTap: () {
                                                          Navigator.push(
                                                            ...
                                                            MaterialPageRoute(
                                                              builder: (context) =>
                                                                  AddUpdateSeriesScreen(id: item?.id, item: item),
                                                            ),
                                                          );
                                                        },
                                                        child: Container(
                                                        ...
                                                        showDialog(
                                                          ...
                                                          builder: (context) {
                                                            return DeleteDialog(
                                                              ...
                                                              onDeletePressed: () {
                                                                context.read<DeleteSeriesCubit>().deleteSeries([
                                                                  item?.id ?? "",
                                                                ]);
                                                                Navigator.pop(context);
                                                              },
                ...
                if (state is GetAllSeriesLoadedState) {
                  return CustomPagination(
                    ...
                    onPageChanged: (e) {
                      ...
                      context.read<GetAllSeriesCubit>().getAllSeries(page: currentPage);
                    },
                  );
                }
                return const SizedBox();
