...
import '../../../bloc/ads/get_all_ads/get_all_ads_cubit.dart';
import '../../../utils/widget/custombutton.dart';

class WebSeriesAdsScreen extends StatefulWidget {
  const WebSeriesAdsScreen({super.key});

  @override
  State<WebSeriesAdsScreen> createState() => _WebSeriesAdsScreenState();
}

class _WebSeriesAdsScreenState extends State<WebSeriesAdsScreen> with Utility {
  int currentPage = 1;
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              heightBox15(),
              BlocBuilder<GetWebAdsCubit, GetWebAdsState>(
                builder: (context, state) {
                  if (state is GetWebAdsLoadedState) {
