...
class SeasonAddUpdateScreen extends StatefulWidget {
  ...
  @override
  State<SeasonAddUpdateScreen> createState() => _SeasonAddUpdateScreenState();
}

class _SeasonAddUpdateScreenState extends State<SeasonAddUpdateScreen> with Utility {
  ...
  void uploadSeasons() {
    if (seasonList.isNotEmpty) {
      context.read<PostSeasonCubit>().postSeason(season: seasonList);
    }
  }
