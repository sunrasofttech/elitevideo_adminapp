      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const TextWidget(text: "Manage Season", fontSize: 15, fontWeight: FontWeight.w600),
              heightBox15(),
              Row(
                children: [
                  Expanded(
                    child: TextFormFieldWidget(
                      ...
                      onChanged: (p0) {
                        context.read<GetAllSeasonCubit>().getAllSeason(search: p0);
                      },
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const SeasonAddUpdateScreen()));
                    },
                    child: Container(
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                TextWidget(text: "${data?.seasonName}", color: AppColors.greyColor),
                                              ],
                                            ),
                                          ),
                                          Row(
                                              ...
                                              InkWell(
                                                onTap: () {
                                                  Navigator.push(
                                                    ...
                                                    MaterialPageRoute(
                                                      builder: (context) =>
                                                          SeasonAddUpdateScreen(id: data?.id, data: data),
                                                    ),
                                                  );
                                                },
                                                  ...
                                                  showDialog(
                                                    ...
                                                    builder: (context) {
                                                      return DeleteDialog(
                                                        ...
                                                        onDeletePressed: () {
                                                          context.read<DeleteSeasonCubit>().deleteSeason(
                                                            data?.id ?? "",
                                                          );
                                                        },
                                                      );
                  ...
                  if (state is GetAllSeasonLoadedState) {
                    return CustomPagination(
                      ...
                      onPageChanged: (e) {
                        ...
                        context.read<GetAllSeasonCubit>().getAllSeason(page: currentPage);
                      },
                    );
                  }
                  return const SizedBox();
