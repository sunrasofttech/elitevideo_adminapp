...
import 'package:elite_admin/presentation/tv_show/add_update_tv_show.dart';
...
class _TvShowScreenState extends State<TvShowScreen> with Utility {
                                  ...
                                  onTap: () {
                                    showDialog(
                                      ...
                                      builder: (_) => DeleteDialog(
                                        ...
                                        onDeletePressed: () {
                                          context.read<DeleteTvShowSeriesCubit>().deleteSeries(selectedMovieIds);
                                          Navigator.pop(context);
                                        },
                                      ),
                                    );
