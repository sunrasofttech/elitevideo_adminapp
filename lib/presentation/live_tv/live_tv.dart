    ...
    return RefreshIndicator(
      ...
      child: Scaffold(
        body: Padding(
          ...
          child: ListView(
            children: [
              const TextWidget(text: "Manage Live Tv", fontSize: 15, fontWeight: FontWeight.w600),
              heightBox15(),
              Row(
                children: [
                  Expanded(
                    child: TextFormFieldWidget(
                      ...
                      onChanged: (p0) {
                        context.read<GetLiveTvCubit>().getAllLiveCategory(search: p0);
                      },
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const AddUpdateLiveTvScreen()));
                    },
                    child: Container(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () {
                                                            Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                builder: (context) =>
                                                                    AddUpdateLiveTvScreen(id: item?.id, model: item),
                                                              ),
                                                            );
                                                          },
                                                          child: Container(
                                                        ...
                                                        showDialog(
                                                          ...
                                                          builder: (context) {
                                                            return DeleteDialog(
                                                              ...
                                                              onDeletePressed: () {
                                                                context.read<DeleteLiveTvCubit>().deleteLiveTv([
                                                                  item?.id ?? "",
                                                                ]);
                                                              },
                                                            );
                  ...
                  if (state is GetLiveTvLoadedState) {
                    return CustomPagination(
                      ...
                      onPageChanged: (e) {
                        ...
                        context.read<GetLiveTvCubit>().getAllLiveCategory(page: currentPage);
                      },
                    );
                  }
                  return const SizedBox();
