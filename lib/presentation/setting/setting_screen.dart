      ...
      child: Scaffold(
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: BlocConsumer<GetSettingCubit, GetSettingState>(listener: (context, state) {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          heightBox15(),
                          const TextWidget(
                            text: "App Required Version",
                          ),
                          heightBox10(),
                          TextFormFieldWidget(
                            controller: requiredVersion,
                          ),
                          heightBox15(),
                          const TextWidget(
                            text: "Selected Payment Type",
                          ),
                          heightBox10(),
                          CustomDropdown(
                            items: paymentType,
                          ...
                          heightBox10(),
                          TextFormFieldWidget(
                            controller: razorpayKey,
                          ),
                          heightBox15(),
                          const TextWidget(
                            text: "Razorpay Secret Key",
                          ),
                          heightBox10(),
                          TextFormFieldWidget(
                            controller: secrectKey,
                          ),
                          heightBox15(),
                          const TextWidget(
                            text: "Phone Pay Key",
                          ...
                          heightBox10(),
                          TextFormFieldWidget(
                            controller: phonepayKey,
                          ),
                          heightBox15(),
                          const TextWidget(
                            text: "Phone Pay Salt Key",
                          ),
                          heightBox10(),
                          TextFormFieldWidget(
                            controller: phonepayPaySaltKey,
                          ),
                          heightBox15(),
                          const TextWidget(
                            text: "Cashfree Client Id",
                          ),
                          heightBox10(),
                          TextFormFieldWidget(
                          ...
                          heightBox15(),
                          const TextWidget(
                            text: "Cashfree Client Secret Key",
                          ),
                          heightBox10(),
                          TextFormFieldWidget(
                            controller: cashfreeClientSecretKey,
                          ),
                          heightBox15(),
                          const TextWidget(
                          ...
                          heightBox15(),
                          const TextWidget(
                            text: "Show Subscription On Music",
                          ),
                          heightBox10(),
                          Switch(
