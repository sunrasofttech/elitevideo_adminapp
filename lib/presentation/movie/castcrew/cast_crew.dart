                            ...
                            builder: (context, value, child) {
                              ...
                              return DropdownSearch<String>(
                                ...
                                selectedItem: marketData
                                    .firstWhere((datum) => datum.id == value, orElse: () => Movie())
                                    .movieName,
                                onChanged: (String? newValue) {
                                  final selectedItem = state.model.data?.movies?.firstWhere(
                                    (datum) => datum.movieName == newValue,
                                  );
                    ...
                    builder: (context, state) {
                      ...
                      if (state is GetAllCastcrewErrorState) {
                        return InkWell(
                          ...
                          child: const Center(child: CustomErrorWidget()),
                        );
                      }
                                                      ...
                                                      showDialog(
                                                        ...
                                                        builder: (context) {
                                                          return DeleteDialog(
                                                            ...
                                                            onDeletePressed: () {
                                                              context.read<DeleteCastCrewCubit>().deleteCastCrew(
                                                                data?.id ?? "",
                                                              );
                                                            },
                                                          );
