...
class _MovieAdsScreenState extends State<MovieAdsScreen> with Utility {
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const TextWidget(text: "Movie Ads", fontSize: 15, fontWeight: FontWeight.w600),
                  InkWell(
                    onTap: () {
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    title: TextWidget(text: "Movie Name : ${data?.movie?.movieName ?? ""}"),
                                            ...
                                            showDialog(
                                              ...
                                              builder: (context) {
                                                return DeleteDialog(
                                                  ...
                                                  onDeletePressed: () {
                                                    context.read<DeleteMovieAdsCubit>().deleteMovieAds(data?.id ?? "");
                                                    Navigator.pop(context);
                                                  },
                                                );
                                              },
  ...
  _addUpdateMovieAdsPopUp({String? videoId, String? movieId, String? id}) {
    return showDialog(
      context: context,
      builder: (context) {
                  ...
                  return Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const TextWidget(text: "Movie Ads", fontWeight: FontWeight.w700, fontSize: 15),
                          InkWell(
                            onTap: () {
                              Navigator.pop(context);
                            },
                                ...
                                if (state is GetAllMovieLaodedState) {
                                  ...
                                  return DropdownSearch<String>(
                                    ...
                                    selectedItem: selectedMovieId != null
                                        ? movies
                                              .firstWhere((e) => e.id == selectedMovieId, orElse: () => Movie())
                                              .movieName
                                        : null,
                                    onChanged: (String? newValue) {
                                      final selectedMovie = movies.firstWhere(
                                        (e) => e.movieName == newValue,
                                        orElse: () => Movie(),
                                      );
                                      setState(() {
                                ...
                                return BlocConsumer<PostMovieAdsCubit, PostMovieAdsState>(
                                  ...
                                  builder: (context, state) {
                                    return CustomOutlinedButton(
                                      inProgress:
                                          (updateState is UpdateMovieAdsLoadingState ||
