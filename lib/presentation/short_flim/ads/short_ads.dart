          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const TextWidget(text: "Short Films Ads", fontSize: 15, fontWeight: FontWeight.w600),
                  InkWell(
                    onTap: () {
                                            ...
                                            showDialog(
                                              ...
                                              builder: (context) {
                                                return DeleteDialog(
                                                  ...
                                                  onDeletePressed: () {
                                                    context.read<DeleteShortFilmAdsCubit>().deleteShortFilm(
                                                      data?.id ?? "",
                                                    );
                                                    Navigator.pop(context);
                                                  },
                  ...
                  if (state is GetShortFlimAdsLoadedState) {
                    return CustomPagination(
                      ...
                      onPageChanged: (e) {
                        ...
                        context.read<GetShortFlimAdsCubit>().getAllWebAds(page: currentPage);
                      },
                    );
                  }
                  ...
                  return Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const TextWidget(text: "Short Films Ads", fontWeight: FontWeight.w700, fontSize: 15),
                          InkWell(
                            onTap: () {
                              Navigator.pop(context);
                            },
                      ...
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const TextWidget(text: "Select Short Film Movies"),
                            heightBox10(),
                                ...
                                return BlocConsumer<PostShortFilmAdsCubit, PostShortFilmAdsState>(
                                  ...
                                  builder: (context, state) {
                                    return CustomOutlinedButton(
                                      inProgress:
                                          (updateState is UpdateShortFilmAdsLoadingState ||
