...
class EpisodeAd {
  ...
  factory EpisodeAd.fromJson(Map<String, dynamic> json) => EpisodeAd(
        ...
        seasonEpisode: json["season_episode"] == null ? null : Datum.fromJson(json["season_episode"]),
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        createdAt: json["createdAt"] == null ? null : DateTime.parse(json["createdAt"]),
        updatedAt: json["updatedAt"] == null ? null : DateTime.parse(json["updatedAt"]),
        episodeAd: json["episode_ad"] == null
            ? []
            : List<EpisodeAd>.from(json["episode_ad"]!.map((x) => EpisodeAd.fromJson(x))),
      );
