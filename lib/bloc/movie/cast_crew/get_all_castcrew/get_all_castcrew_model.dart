...
//
//     final getAllCastCrewModel = getAllCastCrewModelFromJson(jsonString);

import 'dart:convert';

GetAllCastCrewModel getAllCastCrewModelFromJson(String str) => GetAllCastCrewModel.fromJson(json.decode(str));

String getAllCastCrewModelToJson(GetAllCastCrewModel data) => json.encode(data.toJson());

class GetAllCastCrewModel {
    bool? status;
    String? message;
    List<Datum>? data;
    ...
    factory GetAllCastCrewModel.fromJson(Map<String, dynamic> json) => GetAllCastCrewModel(
        status: json["status"],
