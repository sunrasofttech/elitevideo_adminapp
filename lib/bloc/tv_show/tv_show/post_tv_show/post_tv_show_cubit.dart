...
part 'post_tv_show_state.dart';

class PostTvShowSeriesCubit extends Cubit<PostSeriesState> {
  PostTvShowSeriesCubit() : super(PostSeriesInitial());
  ...
  Future<void> postSeries({
    ...
    try {
      ...
      log("Error in postSeries: $e, $s");
      emit(PostSeriesErrorState("Exception: $e"));
    }
  }
}
